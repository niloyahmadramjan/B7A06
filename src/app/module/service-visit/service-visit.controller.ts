...
const getAllServiceVisits = catchAsync(async (req: Request, res: Response) => {
	const result = await serviceVisitService.getAllServiceVisits(
		req.query,
		req.user!,
	);
	sendResponse(res, {
		...
		success: true,
		message: "Service visits retrieved successfully",
		data: result.data,
		meta: result.meta,
	});
});
const getServiceVisitById = catchAsync(async (req: Request, res: Response) => {
	const data = await serviceVisitService.getServiceVisitById(
	...
	sendResponse(res, {
		statusCode: httpStatus.OK,
		success: true,
		message: "Service visit retrieved successfully",
		data,
	});
});
const updateServiceVisit = catchAsync(async (req: Request, res: Response) => {
	const data = await serviceVisitService.updateServiceVisit(
		req.params.visitId as string,
		req.body,
		req.user!,
	);
...
const deleteServiceVisit = catchAsync(async (req: Request, res: Response) => {
	const result = await serviceVisitService.deleteServiceVisit(
		req.params.visitId as string,
	);
	sendResponse(res, {
		statusCode: httpStatus.OK,
